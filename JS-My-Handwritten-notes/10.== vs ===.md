...
- Converts variables to the same type before comparison.
- It compare variables,Ignores the data type.
...
- Checks both value and data type without converting.
- No type coercion is performed.
- It compare variables as well data type.
...
### ✅ Best Practice:
Always use === (strict equality) to avoid unexpected results caused 
by type coercion.
